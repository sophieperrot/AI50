...
knowledge1 = And(
    ...
    #Biconditional(AKnave, Or(And(AKnave, BKnight), And(AKnight, BKnave), And(AKnave, BKnave)))
)
...
knowledge3 = And(
    ...
    Biconditional(AKnight, And(BKnave, CKnight)),
    Biconditional(AKnave, And(BKnave, CKnave)),
